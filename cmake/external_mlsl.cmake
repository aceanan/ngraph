...
#install mpiexec-hydra and pmi_proxy from the process MPI type
install(PROGRAMS ${INSTALL_DIR}/intel64/bin/process/mpiexec
                 ${INSTALL_DIR}/intel64/bin/process/mpiexec.hydra
                 ${INSTALL_DIR}/intel64/bin/process/pmi_proxy
        DESTINATION ${NGRAPH_INSTALL_BIN})
#install other bins from the thread MPI type
install(PROGRAMS ${INSTALL_DIR}/intel64/bin/thread/fi_info
                 ${INSTALL_DIR}/intel64/bin/thread/hydra_bstrap_proxy
                 ${INSTALL_DIR}/intel64/bin/thread/hydra_nameserver
                 ${INSTALL_DIR}/intel64/bin/thread/hydra_pmi_proxy
        DESTINATION ${NGRAPH_INSTALL_BIN})
